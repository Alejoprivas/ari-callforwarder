...
import routes from './reporte.routes';
...
$onInit() {
    ...
    query(){
      ...
      this.$http.post('/api/reportes/query',{
    params: { dt1: this.dt, 
              dt2: this.dt2, 
              user: this.empleado, 
...
export default angular.module('fullstackApp.reporte', [uiRouter])
  .config(routes)
  .component('reporte', {
    template: require('./reporte.html'),
